...
const T: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    heroNote: "Essai gratuit 48 heures · Aucune carte requise",
    ...
    p1t: "Essai gratuit",
    p1d: "48 heures pour tester toutes les fonctionnalités sans engagement.",
    ...
    planCtaSub: "48 heures gratuites, puis contactez-nous via WhatsApp",
    ...
    q2a: "Après votre essai gratuit de 48 heures, contactez-nous sur WhatsApp au +212 644411059. Nous vous enverrons votre code d'activation après confirmation du paiement.",
  ...
  ar: {
    ...
    heroNote: "تجربة مجانية 48 ساعة · بدون بطاقة بنكية",
    ...
    p1t: "تجربة مجانية",
    p1d: "48 ساعة كاملة لاختبار جميع الميزات دون أي التزام.",
    p2t: "التفعيل برمز",
    ...
    planCtaSub: "48 ساعة مجاناً، ثم تواصل معنا عبر واتساب",
    ...
    q2a: "بعد انتهاء تجربتك المجانية لـ 48 ساعة، تواصل معنا على واتساب 212644411059+. سنرسل لك رمز التفعيل بعد تأكيد الدفع.",
